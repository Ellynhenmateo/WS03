...
<body class="bg-gray-100">
    <? require_once loadPartial('navbar'); ?>
    <!-- Nav -->
    ...
    <!-- Showcase -->
    <? require_once loadPartial('showcase-search'); ?>
    ...
    <!-- Top Banner -->
    <? require_once loadPartial('top-banner'); ?>
    ...
    <!-- Bottom Banner -->
    <? require_once loadPartial('bottom-banner'); ?>
